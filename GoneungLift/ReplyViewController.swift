...
class ReplyViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, ReplyCellDelegate {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        let height = commentList[indexPath.row].comment.height(withConstrainedWidth: DEVICE_WIDTH() - 20, font: UIFont.systemFont(ofSize: 17.0))
